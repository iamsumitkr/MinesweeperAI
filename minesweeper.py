...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        """
        # 1) Mark the cell as a that has been made
        self.moves_made.add(cell)
        # 2) mark the cell as safe
        self.mark_safe(cell)

        # 3) Add a new sentence to knowledge base based on the value of cell and count
        ...
        for i in range(cell[0] - 1, cell[0] +2):
            for j in range(cell[1]-1, cell[1]+2):
                ...
                # ignore cells if they are mins and reduce count by 1
        ...
        # Add the new sentence to the AI KB
        self.knowledge.append(Sentence(new_sentence_cells, count))

        # 4) Mark any additional cells as safes or as mines
        ...
        while knowledge_changed:
            ...
            # 5) Add any new sentences to the AI's KB if they can be inferred from new knowledge
